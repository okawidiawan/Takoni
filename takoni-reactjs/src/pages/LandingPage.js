  ...
  return (
    <div className="mt-20 flex">
      <div className="mx-auto flex w-full flex-col">
        ...
        <Link to="/login" className="mx-auto mt-7 w-[150px] rounded-md bg-emerald-400 py-2 text-center font-bold text-white shadow-lg shadow-emerald-400/40 transition duration-300 hover:bg-emerald-500">
          Try it Out
        </Link>
      </div>
    </div>
